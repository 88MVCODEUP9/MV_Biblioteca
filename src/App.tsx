...
// ── Marvel ──────────Guerra Secreta (2015) ────────────────────────────────────────────
  ...
  { id:"267", title:"Lizana to Homeless Capítulo 4", author:"Zetto", fileType:"pdf", filePath:"https://mvin2006.github.io/HQ/Sinful%20Lust/Lizana%20to%20Homeless/Lizana%20to%20Homeless%20Cap%C3%ADtulo%204.pdf", coverPath:"https://mvin2006.github.io/HQ/Sinful%20Lust/Lizana%20to%20Homeless/Lizana%20to%20Homeless%20Cap%C3%ADtulo%204.wbp", collectionId:"Sinful Lust", subCollectionId:"Lizana to Homeless", addedDate:"2026-09-15T00:00:00.000Z" },
      ...
      <aside className="hidden lg:flex fixed left-0 top-0 bottom-0 w-56 bg-[var(--bg-2)] border-r border-[var(--border)] flex-col z-50">
        ...
        <nav className="flex-1 p-3 space-y-0.5">
          {NAV_ITEMS.map(({ id, label, Icon }) => (
            <button
              key={id}
              onClick={() => { setActiveTab(id); if (id !== 'collections') setSelectedCollection(null); }}
